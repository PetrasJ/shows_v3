 ...
 */
class UserEpisodesRepository extends EntityRepository
{
    /**
     * @param $showID
     * @param $user
    ...
    public function getWatchedEpisodes($showID, $userID)
    {
        ...
        $result = $this->createQueryBuilder('p')
            ...
            ->andWhere('p.status = :status')
                ->setParameter('status', UserEpisodes::STATUS_WATCHED)
            ->select('p.episodeID')
            ->getQuery()
            ->getResult();
    ...
    public function getWatchedEpisodesInRange($dateFrom, $dateTo, $user)
    {
        ...
        $result = $this->createQueryBuilder('p')
            ->select('p.episodeID')
            ->innerJoin(UserShows::class, 'us', Join::WITH, 'us.showID = p.showID AND us.userID = :userID')
            ...
            ->setParameters([
                'userID' => $userID,
                'status' => UserEpisodes::STATUS_WATCHED,
                'dateFrom' => $dateFrom,
                'dateTo' => $dateTo
            ])
            ->getQuery()
